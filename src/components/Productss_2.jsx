      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        {product.map((item) => {
          return (
            <div
              key={item.id}
              className="flex flex-col justify-between p-5 bg-white rounded-xl shadow-xl shadow-gray-400/50 hover:shadow-2xl transition-shadow duration-300"
            >
              ...
              <div className="flex-grow flex flex-col justify-between">
                <div>
                  <h2 className="font-bold p-1 text-gray-800 text-sm sm:text-base">
                    {item.title}
                  </h2>
